...
All figures below are generated by `scripts/reproduction/generate_v5_figures.py` and `scripts/reproduction/generate_v6_figures.py` from the JSONL result files in `outputs/results/`; re-running the eval scripts and then the figure scripts reproduces every chart shown.
